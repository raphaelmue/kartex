...
- [x] 27-01-PLAN.md — Extract importMedia.ts shared helper from import.ts + add .kartex.zip branch to deckUpdate.ts preview/apply + backend tests (DECKU-01/02/03/04)
...
- [x] 29-02-PLAN.md — Foundation: AuthContext User.email, i18n keys (both locales), REQUIREMENTS.md reconciliation
...
| 29. User Email Self-Service | v1.4.0 | 2/4 | In Progress|  |
