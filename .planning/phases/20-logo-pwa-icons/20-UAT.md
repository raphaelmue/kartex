...
<!-- inline fix applied during test 1: k-letter dark-mode class added to logo.svg + favicon.svg -->
...
result: pass
note: "k" appeared dark in dark mode — fixed inline by adding .k-letter dark-mode media query to logo.svg + favicon.svg
...
result: pass
note: required switching from <img> to inline KartexLogo SVG component — prefers-color-scheme inside a sandboxed img does not fire with darkMode:'class'
