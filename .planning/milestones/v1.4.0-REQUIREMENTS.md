# Requirements Archive: v1.4.0 Auth Overhaul & Study UX
...
- [x] **ABC-01**: `#abc` fenced blocks in card content render as SVG sheet music inline in the card
- [x] **ABC-02**: Invalid ABC notation shows an error fallback (not a crash or blank space)
- [x] **ABC-03**: Rendered SVG scales to card width (responsive on mobile and desktop)
...
| ABC-01 | Phase 26 | Complete |
| ABC-02 | Phase 26 | Complete |
| ABC-03 | Phase 26 | Complete |
